...
def parse_arguments():
    ...
    parser.add_argument('--loss_func', type=str, default='tversky', help='Loss function to use: bce, dice, dice2, focal, lovasz, tversky')
    ...
    parser.add_argument('--mixed_precision', action='store_true', default=True, help='use bf16 instead of fp32')
    parser.add_argument('--grad_accumulation', type=int, default=2, help='simulate batch size x g')
